...
-- -----------------------------------------------------
-- Table `bookstore`.`products`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bookstore`.`products` (
...
CREATE TABLE IF NOT EXISTS `bookstore`.`cart` (
  ...
  CONSTRAINT `fk_CART_PRODUCTS1`
    ...
    REFERENCES `bookstore`.`products` (`product_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `bookstore`.`prod_cat`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bookstore`.`prod_cat` (
  `products_product_id` INT NOT NULL,
  ...
  CONSTRAINT `fk_PROD_CAT_CATEGORIES1`
    ...
    REFERENCES `bookstore`.`categories` (`categorie_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
